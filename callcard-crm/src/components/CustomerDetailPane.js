...
function makeStyles(theme) {
  return StyleSheet.create({
    ...
    customerName:   { fontFamily: theme.fontHeading, fontSize: theme.fontSize.xl, color: theme.textPrimary, flex: 1, marginRight: 8 },
    ...
    infoValue:        { fontFamily: theme.fontBody, fontSize: theme.fontSize.sm, color: theme.textSecondary, flex: 1 },
    ...
    fieldLabel:     { fontFamily: theme.fontUiMedium, fontSize: theme.fontSize.xs, color: theme.textMuted, marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 },
    input:          { fontFamily: theme.fontBody, fontSize: theme.fontSize.base, color: theme.textPrimary, backgroundColor: theme.surface, borderWidth: 1, borderColor: theme.border, borderRadius: 8, paddingVertical: 10, paddingHorizontal: 12 },
    ...
    suggestionMain: { fontFamily: theme.fontBody, fontSize: theme.fontSize.sm, color: theme.textPrimary },
    suggestionSub:  { fontFamily: theme.fontBody, fontSize: theme.fontSize.xs, color: theme.textMuted, marginTop: 1 },
    ...
    saveBtnText:    { fontFamily: theme.fontUiMedium, fontSize: theme.fontSize.base, color: '#fff' },
    // Equipment
    ...
    lastServiceDate:    { fontFamily: theme.fontBody, fontSize: theme.fontSize.xs, color: theme.textMuted },
    equipSection:       { paddingHorizontal: 20, paddingBottom: 16 },
    equipEditSection:   { paddingHorizontal: 20, paddingBottom: 16 },
    equipTitle:         { fontFamily: theme.fontUiMedium, fontSize: theme.fontSize.xs, color: theme.textMuted, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 },
    equipRow:           { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 4 },
    equipLabel:         { fontFamily: theme.fontBody, fontSize: theme.fontSize.sm, color: theme.textMuted },
    equipValue:         { fontFamily: theme.fontBodyMedium, fontSize: theme.fontSize.sm, color: theme.textPrimary, flex: 1, textAlign: 'right' },
    ...
    equipPickerValue:   { fontFamily: theme.fontBody, fontSize: theme.fontSize.base, color: theme.textPrimary },
    equipPickerPlaceholder: { fontFamily: theme.fontBody, fontSize: theme.fontSize.base, color: theme.placeholder },
    // Divider + log
    ...
    logTitle:     { fontFamily: theme.fontUiMedium, fontSize: theme.fontSize.xs, color: theme.textMuted, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 10 },
    ...
    emptyLogText: { fontFamily: theme.fontBody, fontSize: theme.fontSize.sm, color: theme.textSecondary },
    emptyLogHint: { fontFamily: theme.fontBody, fontSize: theme.fontSize.xs, color: theme.textMuted, textAlign: 'center', lineHeight: 18 },
    // Scheduled
    ...
    schedLabel:     { fontFamily: theme.fontBodyMedium, fontSize: theme.fontSize.sm, color: theme.textPrimary },
    schedDate:      { fontFamily: theme.fontBody, fontSize: theme.fontSize.xs, color: theme.textMuted },
    schedTime:      { fontFamily: theme.fontBody, fontSize: theme.fontSize.xs, color: theme.textSecondary, marginTop: 1 },
    schedNotes:     { fontFamily: theme.fontBody, fontSize: theme.fontSize.xs, color: theme.textMuted, lineHeight: 16, marginTop: 4 },
    ...
    footerBtnText:  { fontFamily: theme.fontUiMedium, fontSize: theme.fontSize.base, color: '#fff' },
